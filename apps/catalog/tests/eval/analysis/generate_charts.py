...
summary_evo = (
    df.groupby("experiment")[["overall_score", "faithfulness", "answer_relevancy"]]
    .mean()
    .reset_index()
)
...
ax.set_ylim(0.6, 1.0)
ax.axhline(
    0.8, color="green", linestyle="--", linewidth=1, alpha=0.5, label="Target 0.8"
)
