...
def main():
    ...
    foods_with_nutrients = set(
        nutrients_final[nutrients_final["calories_100g"].notna()]["food_id"]
    )
    foods_final = foods_final[foods_final["id"].isin(foods_with_nutrients)]
    nutrients_final = nutrients_final[
        nutrients_final["food_id"].isin(foods_with_nutrients)
    ]
