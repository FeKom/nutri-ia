...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("USDA", "TACO", "CUSTOM", name="foodsource"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_foods_name_normalized"), "foods", ["name_normalized"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "saturated_fat_g_100g", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "vitamin_c_mg_100g", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
