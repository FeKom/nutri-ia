...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_daily_stats_user_date", "daily_stats", ["user_id", "date"], unique=True
    )
    op.create_table(
        "meal_logs",
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_meal_logs_consumed_at"), "meal_logs", ["consumed_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=False),
        sa.Column(
            "plan_name", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "diet_goal",
            sa.Enum("WEIGHT_LOSS", "WEIGHT_GAIN", "MAINTAIN", name="dietgoal"),
            nullable=False,
        ),
